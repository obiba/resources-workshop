...
The [resourcer](https://cran.r-project.org/package=resourcer) package is an R implementation of the concept of Resources (see also the [source repository](https://github.com/obiba/resourcer)).
...
See also [Tutorial: Using the resources in Opal and DataSHIELD](https://rpubs.com/jrgonzalezISGlobal/tutorial_resources).
