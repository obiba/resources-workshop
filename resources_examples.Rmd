...
This tutorial aims to provide examples about how to deal with resources in Opal and DataSHIELD. More detailed information can be found in [our bookdown](https://isglobal-brge.github.io/resource_bookdown/).

A quick demo of the resources is also available [here](https://rpubs.com/ymarcon/713068).
...
```{r eSet, echo=FALSE, fig.cap='ExpressionSet infrastructure', fig.align='center', out.width = '60%'}
...
```{r plinkResources, echo=FALSE, fig.cap='Computation resource corresponding to PLINK example',  fig.align='center', out.width = '40%'}
