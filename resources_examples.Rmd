...
>
> 2. Login the connection to the resource to DataSHIELD and assign the resources to an object having the same name as the resource name (in my case eSet_DrMMuZ).
>
