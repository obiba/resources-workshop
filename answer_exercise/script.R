...
opal.resources(o, project='RSRC')[, 1:2]
...
opal.resource_delete(opal=o, project='RSRC', resource='quebec_jrgonz')
opal.resource_delete(opal=o, project='RSRC', resource='mississippi_jrgonz')
